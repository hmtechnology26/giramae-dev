        ...
        <div className="relative z-10 w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <Card className="premium-card relative overflow-hidden rounded-[2.75rem] border border-black/15 bg-white/75 shadow-[0_28px_60px_-18px_rgba(0,0,0,0.10)] backdrop-blur-2xl md:rounded-[3.25rem]">
            ...
            <CardContent className="space-y-8 px-6 pb-8 md:px-8 md:pb-10">
              <div className="space-y-5">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] text-foreground/20">
                    <ShieldCheck className="h-3.5 w-3.5" /> Acesso 100% Seguro
                  </div>
              ...
              <div className="flex justify-center gap-10 border-t border-primary/5 pt-6">
                <div className="flex flex-col items-center gap-1">
                  <span className="text-base font-black text-foreground/60">5k+</span>
                  <span className="text-center text-[9px] font-black uppercase tracking-widest text-foreground/20">
                    Mães Ativas
                  </span>
                </div>

                <div className="h-8 w-px self-center bg-primary/5" />

                <div className="flex flex-col items-center gap-1">
                  <span className="text-base font-black text-foreground/60">20k+</span>
                  <span className="text-center text-[9px] font-black uppercase tracking-widest text-foreground/20">
                    Peças Trocadas
                  </span>
                </div>
          ...
          <div className="mt-8 flex flex-col items-center gap-5 text-center">
            {/* <Link
              to="/"
              className="inline-flex items-center gap-2 opacity-40 transition-opacity duration-700 hover:opacity-100 group"
            >
              <img src="/giramae_logo.png" className="h-12 md:h-14 w-auto" alt="GiraMãe Logo" />
            </Link> */}
